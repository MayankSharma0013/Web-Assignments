...
let url=`http://api.weatherstack.com/current?access_key=0af182bb99fb84e50896b2321bb1cb81&query=New%20York`;
function getweather(b){
    ...
    let url=`http://api.weatherstack.com/current?access_key=0af182bb99fb84e50896b2321bb1cb81&query=${cityname}`;
    console.log(url);
    fetch(url).then((res)=>{
     return res.json();
    })
